...
class MonthCalendarMixin(BaseCalendarMixin):
    ...
    def get_current_month(self):
        ...
        """scheduleidによる変化"""
        if self.kwargs.get('scheduleid') != None:
            scheduleidschedule=Schedule.objects.get(id=self.kwargs.get('scheduleid'))
            day=scheduleidschedule.date.day
            month=scheduleidschedule.date.month
            year=scheduleidschedule.date.year
